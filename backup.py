...
class Recovery_Account:
    st.set_page_config(
        page_title="Recovery Account"
    )
    add_select_box = st.sidebar.selectbox("Platform   :",
                                          ("Instagram",
                                           "Twitter",
                                           "Facebook",
                                           "Youtube",
    ...
    if add_select_box == "Instagram":
        st.markdown("<h2 style='text-align: center; color: black;'>Recovery Instagram </h2> <br/> <br/>",
                    unsafe_allow_html=True)
        tab1, tab2 = st.tabs(["📝 Input", "📁 Import"])
            ...
            def in_submit(self):
                try:
                    with st.spinner('Wait for it...'):
                        time.sleep(5)
                    st.success('Done!')
                    main_.list_input.extend(self.username_ig)
    ...
    # Twitter
    elif add_select_box == "Twitter":
        st.markdown("<h2 style='text-align: center; color: black;'>Recovery Twitter </h2> <br/> <br/>",
                    unsafe_allow_html=True)
        tab1, tab2 = st.tabs(["📝 Input", "🗃 Import"])
        with st.form("my_form"):
            with tab1:
    ...
    # Facebook
    elif add_select_box == "Facebook":
        st.markdown("<h2 style='text-align: center; color: black;'>Recovery Facebook </h2> <br/> <br/>",
                    unsafe_allow_html=True)
        tab1, tab2 = st.tabs(["📈 Input", "🗃 Import"])
        with st.form("my_form"):
            with tab1:
    ...
    # Youtube
    elif add_select_box == "Youtube":
        st.markdown("<h2 style='text-align: center; color: black;'>Recovery Youtube </h2> <br/> <br/>",
                    unsafe_allow_html=True)
        tab1, tab2 = st.tabs(["📈 Input", "🗃 Import"])
        with st.form("my_form"):
            with tab1:
    ...
    # Tiktok
    elif add_select_box == "Tiktok":
        st.markdown("<h2 style='text-align: center; color: black;'>Recovery Tiktok </h2> <br/> <br/>",
                    unsafe_allow_html=True)
        st.info("Coming soon!")
